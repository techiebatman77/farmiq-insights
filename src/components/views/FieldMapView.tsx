...
import { Map, Layers, Satellite, TreeDeciduous, Plus, Filter } from 'lucide-react';
    ...
    fields.forEach((field) => {
      ...
      polygon.bindPopup(`
        <div style="min-width: 180px;">
          ...
          <p style="margin: 4px 0; font-size: 12px;">Area: <strong>${field.area}</strong></p>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="stat-card p-0 overflow-hidden">
        <div className="p-4 border-b border-border flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-muted-foreground ml-2">({fields.length} fields)</span>
          </div>
            ...
            <div className="absolute top-4 right-4 bg-background/95 backdrop-blur-sm rounded-lg p-4 shadow-lg z-[1000] min-w-[250px]">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{selectedField.area}</span>
                </div>
                <div className="flex justify-between">
      ...
      <div className="stat-card">
        <h3 className="font-semibold mb-4">All Fields</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {fields.map((field) => (
            ...
            >
              ...
              <p className="text-xs text-muted-foreground mb-1">{field.crop} • {field.area}</p>
